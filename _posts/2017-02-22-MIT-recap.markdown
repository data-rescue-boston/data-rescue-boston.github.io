...
<img class="photo" src="{{ "/assets/photos/long-trail.jpg" | relative_url }}"/><p> As a part of the event, we had a breakout session with attendees, organizers, and members of EDGI responsible for coordinating the national DataRescue movement on how to improve DataRescue efforts and tools, what are the main goals and priorities of the movement, and what are the best ways to accomplish those? These discussions are ongoing, and we want you to be a part of them moving forward. To get involved:</p></div>
<p><a class="btn btn-default" href="{{"/meetings/" | relative_url}}"><i class="fa fa-users"></i> Attend our weekly meetings</a></p>
